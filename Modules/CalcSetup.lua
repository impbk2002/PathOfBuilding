...
function calcs.initModDB(env, modDB)
	...
	modDB:NewMod("ChillingConflux", "FLAG", true, "Base", { type = "Condition", var = "ChillingConflux" }, { type = "Condition", var = "ElementalConflux", neg = true })
	modDB:NewMod("ShockingConflux", "FLAG", true, "Base", { type = "Condition", var = "ShockingConflux" }, { type = "Condition", var = "ElementalConflux", neg = true })
	modDB:NewMod("IgnitingConflux", "FLAG", true, "Base", { type = "Condition", var = "IgnitingConflux" }, { type = "Condition", var = "ElementalConflux", neg = true })
	modDB:NewMod("FreezingConflux", "FLAG", true, "Base", { type = "Condition", var = "FreezingConflux" })
	modDB:NewMod("ElementalConflux", "FLAG", true, "Base", { type = "Condition", var = "ElementalConflux" })
	modDB:NewMod("ScorchingConflux", "FLAG", true, "Base", { type = "Condition", var = "ScorchingConflux" })
	modDB:NewMod("Condition:CanInflictScorch", "FLAG", true, "Base", { type = "Condition", var = "ScorchingConflux" })
	modDB:NewMod("BrittleConflux", "FLAG", true, "Base", { type = "Condition", var = "BrittleConflux" })
	modDB:NewMod("Condition:CanInflictBrittle", "FLAG", true, "Base", { type = "Condition", var = "BrittleConflux" })
	modDB:NewMod("SappingConflux", "FLAG", true, "Base", { type = "Condition", var = "SappingConflux" })
	modDB:NewMod("Condition:CanInflictSap", "FLAG", true, "Base", { type = "Condition", var = "SappingConflux" })
	...
	modDB:NewMod("Condition:AffectedByArcaneSurge", "FLAG", true, "Arcane Surge", { type = "Condition", var = "ArcaneSurge" })
