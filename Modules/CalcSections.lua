...
{ 1, "Armour", 3, colorCodes.DEFENCE, {{ defaultCollapsed = false, label = "Armour", data = {
	...
	{ label = "Phys. Dmg. Reduct", haveOutput = "PhysicalDamageReductionResist", { format = "{0:output:PhysicalDamageReduction}%", 
		{ breakdown = "PhysicalDamageReduction" },
		{ modName = { "PhysicalResistance", "PhysicalDamageReduction", "PhysicalDamageReductionWhenHit", "ArmourDoesNotApplyToPhysicalDamageTaken", "DamageReductionMax" } }, 
	}, },
	{ label = "Phys. Dmg. Reduct", haveOutput = "PhysicalResistTotal", { format = "{0:output:PhysicalDamageReduction}%", 
		{ breakdown = "PhysicalDamageReduction" },
		{ modName = { "PhysicalResistance", "PhysicalDamageReductionWhenHit", "ArmourDoesNotApplyToPhysicalDamageTaken", "DamageReductionMax" } }, 
	}, },
...
{ 1, "MiscDefences", 3, colorCodes.DEFENCE, {{ defaultCollapsed = false, label = "Other Defences", data = {
	...
	{ label = "Dodge Chance", { format = "{0:output:AttackDodgeChance}%",
		{ breakdown = "AttackDodgeChance" },
		{ modName = "AttackDodgeChance" },
	}, },
	{ label = "Spell Ddg. Chance", { format = "{0:output:SpellDodgeChance}%",
		{ breakdown = "SpellDodgeChance" },
		{ modName = "SpellDodgeChance" },
	}, }, 
} },
} },
